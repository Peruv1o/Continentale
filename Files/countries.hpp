...
inline vector<string> northAmerica = {
...
inline vector<string> southAmerica = {
        "Argentina", "Bolivia", "Brazil", "Chile", "Colombia",
        "Ecuador", "Guyana", "Paraguay", "Peru", "Suriname",
        "Uruguay", "Venezuela"
    };

inline vector<string> africa = {
